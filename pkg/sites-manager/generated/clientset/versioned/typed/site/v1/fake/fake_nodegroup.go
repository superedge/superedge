...
var nodegroupsKind = schema.GroupVersionKind{Group: "site.superedge.io", Version: "v1", Kind: "NodeGroup"}
...
func (c *FakeNodeGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *sitev1.NodeGroup, err error) {
	...
	return obj.(*sitev1.NodeGroup), err
}
...
func (c *FakeNodeGroups) List(ctx context.Context, opts v1.ListOptions) (result *sitev1.NodeGroupList, err error) {
	...
	list := &sitev1.NodeGroupList{ListMeta: obj.(*sitev1.NodeGroupList).ListMeta}
	for _, item := range obj.(*sitev1.NodeGroupList).Items {
