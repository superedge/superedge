...
import (
	...
	versioned "github.com/superedge/superedge/pkg/sites-manager/generated/clientset/versioned"
	internalinterfaces "github.com/superedge/superedge/pkg/sites-manager/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/superedge/superedge/pkg/sites-manager/generated/listers/site/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SiteV1().NodeGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SiteV1().NodeGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&sitev1.NodeGroup{},
		resyncPeriod,
