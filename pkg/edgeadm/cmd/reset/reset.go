...
import (
	...
	phases "github.com/superedge/superedge/pkg/util/kubeadm/app/cmd/phases/reset"
...
func NewCmdReset(in io.Reader, out io.Writer, edgeConfig *cmd.EdgeadmConfig) *cobra.Command {
