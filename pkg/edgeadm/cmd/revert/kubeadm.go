...
func (r *revertAction) revertKubeProxyKubeconfig() error {
	kubeClient := r.clientSet
	if err := kubeClient.AppsV1().DaemonSets(constant.NamespcaeKubeSystem).Delete(context.TODO(), constant.KubeProxyEdge, metav1.DeleteOptions{}); err != nil {
		return err
	}

	if err := kubeClient.CoreV1().ConfigMaps(constant.NamespcaeKubeSystem).Delete(context.TODO(), constant.KubeProxyEdge, metav1.DeleteOptions{}); err != nil {
		return err
	}
