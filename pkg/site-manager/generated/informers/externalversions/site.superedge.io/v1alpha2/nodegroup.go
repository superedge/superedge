...
type NodeGroupInformer interface {
	...
	Lister() v1alpha2.NodeGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SiteV1alpha2().NodeGroups().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SiteV1alpha2().NodeGroups().Watch(context.TODO(), options)
			},
		},
		&sitesuperedgeiov1alpha2.NodeGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sitesuperedgeiov1alpha2.NodeGroup{}, f.defaultInformer)
}

func (f *nodeGroupInformer) Lister() v1alpha2.NodeGroupLister {
	return v1alpha2.NewNodeGroupLister(f.Informer().GetIndexer())
}
