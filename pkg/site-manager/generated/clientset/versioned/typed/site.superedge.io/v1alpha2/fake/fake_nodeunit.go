...
var nodeunitsResource = schema.GroupVersionResource{Group: "site.superedge.io", Version: "v1alpha2", Resource: "nodeunits"}

var nodeunitsKind = schema.GroupVersionKind{Group: "site.superedge.io", Version: "v1alpha2", Kind: "NodeUnit"}
...
func (c *FakeNodeUnits) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.NodeUnit, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(nodeunitsResource, name), &v1alpha2.NodeUnit{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeUnit), err
}
...
func (c *FakeNodeUnits) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.NodeUnitList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(nodeunitsResource, nodeunitsKind, opts), &v1alpha2.NodeUnitList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha2.NodeUnitList{ListMeta: obj.(*v1alpha2.NodeUnitList).ListMeta}
	for _, item := range obj.(*v1alpha2.NodeUnitList).Items {
...
func (c *FakeNodeUnits) Create(ctx context.Context, nodeUnit *v1alpha2.NodeUnit, opts v1.CreateOptions) (result *v1alpha2.NodeUnit, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(nodeunitsResource, nodeUnit), &v1alpha2.NodeUnit{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeUnit), err
...
func (c *FakeNodeUnits) Update(ctx context.Context, nodeUnit *v1alpha2.NodeUnit, opts v1.UpdateOptions) (result *v1alpha2.NodeUnit, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(nodeunitsResource, nodeUnit), &v1alpha2.NodeUnit{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeUnit), err
...
func (c *FakeNodeUnits) UpdateStatus(ctx context.Context, nodeUnit *v1alpha2.NodeUnit, opts v1.UpdateOptions) (*v1alpha2.NodeUnit, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(nodeunitsResource, "status", nodeUnit), &v1alpha2.NodeUnit{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeUnit), err
...
func (c *FakeNodeUnits) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(nodeunitsResource, name), &v1alpha2.NodeUnit{})
	return err
}
...
func (c *FakeNodeUnits) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.NodeUnitList{})
	return err
}
...
func (c *FakeNodeUnits) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.NodeUnit, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(nodeunitsResource, name, pt, data, subresources...), &v1alpha2.NodeUnit{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeUnit), err
