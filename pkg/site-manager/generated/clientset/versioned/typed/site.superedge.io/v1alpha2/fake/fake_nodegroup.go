...
var nodegroupsResource = schema.GroupVersionResource{Group: "site.superedge.io", Version: "v1alpha2", Resource: "nodegroups"}

var nodegroupsKind = schema.GroupVersionKind{Group: "site.superedge.io", Version: "v1alpha2", Kind: "NodeGroup"}
...
func (c *FakeNodeGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.NodeGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(nodegroupsResource, name), &v1alpha2.NodeGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeGroup), err
}
...
func (c *FakeNodeGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.NodeGroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(nodegroupsResource, nodegroupsKind, opts), &v1alpha2.NodeGroupList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha2.NodeGroupList{ListMeta: obj.(*v1alpha2.NodeGroupList).ListMeta}
	for _, item := range obj.(*v1alpha2.NodeGroupList).Items {
...
func (c *FakeNodeGroups) Create(ctx context.Context, nodeGroup *v1alpha2.NodeGroup, opts v1.CreateOptions) (result *v1alpha2.NodeGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(nodegroupsResource, nodeGroup), &v1alpha2.NodeGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeGroup), err
...
func (c *FakeNodeGroups) Update(ctx context.Context, nodeGroup *v1alpha2.NodeGroup, opts v1.UpdateOptions) (result *v1alpha2.NodeGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(nodegroupsResource, nodeGroup), &v1alpha2.NodeGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeGroup), err
...
func (c *FakeNodeGroups) UpdateStatus(ctx context.Context, nodeGroup *v1alpha2.NodeGroup, opts v1.UpdateOptions) (*v1alpha2.NodeGroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(nodegroupsResource, "status", nodeGroup), &v1alpha2.NodeGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeGroup), err
...
func (c *FakeNodeGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(nodegroupsResource, name), &v1alpha2.NodeGroup{})
	return err
}
...
func (c *FakeNodeGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.NodeGroupList{})
	return err
}
...
func (c *FakeNodeGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.NodeGroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(nodegroupsResource, name, pt, data, subresources...), &v1alpha2.NodeGroup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.NodeGroup), err
