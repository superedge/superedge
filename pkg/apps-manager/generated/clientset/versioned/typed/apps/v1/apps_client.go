...
import (
	...
	"github.com/superedge/superedge/pkg/apps-manager/generated/clientset/versioned/scheme"
...
// AppsV1Client is used to interact with features provided by the apps.superedge.io group.
type AppsV1Client struct {
	restClient rest.Interface
}

func (c *AppsV1Client) EDeployments(namespace string) EDeploymentInterface {
	return newEDeployments(c, namespace)
}
